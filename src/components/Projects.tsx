...
export default function Projects() {
  ...
  /* Map vertical progress → horizontal translate of the track */
  const cardWidth  = 480   // px per card + gap, approximate
  ...
  return (
    /* The outer section is tall so we have room to scroll */
    <section
      id="projects"
      ref={sectionRef}
      className="relative border-b border-white/10"
      /* Height = viewport × number of cards so we get enough scroll room */
      style={{ height: `${(projects.length + 1) * 100}vh` }}
    >
      {/* Sticky container — stays in view while we scroll through the tall section */}
        ...
        <div ref={trackRef} className="relative mx-auto w-full max-w-6xl px-6">
          ...
          >
            {projects.map((project, i) => (
              ...
              >
                {/* Index badge */}
                <p className="mb-3 font-mono text-[11px] font-bold tracking-[0.3em]
                  text-cyan-500/50 uppercase">
