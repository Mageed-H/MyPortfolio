...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Noise grain — desktop only to prevent mobile GPU/CPU freeze */}
      <div aria-hidden className="pointer-events-none fixed inset-0 z-0 hidden md:block opacity-[0.018] dark:opacity-[0.03]"
